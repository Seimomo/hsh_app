...
<div class="content hsh-container">
    ...
    <p>この利用規約（以下，「本規約」といいます。）は，Homepage Skill Helper All（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
    ...
    <h2>第4条（依頼登録および納品、検収）</h2>
    <ol>
    <li>ユーザーは，本サービスの利用方法として，当社がトップページに記載する方法,および利用上の注意点を遵守して利用することとします。</li>
    <li>ユーザーがそれ以外の方法で利用した場合に負った損害について，一切の責任を負いません。</li>
    </ol>
    ...
    <li>法人として依頼した場合</li>
    <li>アカウントの不正利用等で複数の依頼を同時期に行ったことが明らかな場合</li>
    <li>依頼者のサイトで不正な行為を行った場合</li>
    ...
    <h2>第9条（退会）</h2>
    <p>ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。ただしユーザの登録，納品したデータは削除されません。</p>
